...
public class CLIParserTest {
    ...
    public void testSimpleUninstallWithOnlyFilter() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, null, false, false, false, false, false, false);
        ...
        Arg expectedArg1 = new Arg("com.android.*,com.google.*", null, null, null, false, false, false, false, false, false);
    ...
    public void testSimpleInstallWithOnlyFile() throws Exception {
        ...
        Arg expectedArg = new Arg(null, "app.apk", null, null, false, false, false, false, false, false);
        assertEquals(parsedArg, expectedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_INSTALL + " ./"));
        Arg expectedArg1 = new Arg(null, "./", null, null, false, false, false, false, false, false);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testAdbPathArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, "C:\\test\\my path\\adb.exe", null, false, false, false, false, false, false);
        assertEquals(parsedArg, expectedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_UNINSTALL + " com.android.* -adbPath C:\\test\\mypath\\adb.exe"));
        Arg expectedArg1 = new Arg("com.android.*", null, "C:\\test\\mypath\\adb.exe", null, false, false, false, false, false, false);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testDeviceArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, "IR2131236", false, false, false, false, false, false);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testDryrunArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, null, true, false, false, false, false, false);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testSkipEmusArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, null, false, true, false, false, false, false);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testKeepDataArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, null, false, false, true, false, false, false);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testUpgradeArg() throws Exception {
        ...
        Arg expectedArg = new Arg(null, "/data/app.apk", null, null, false, false, true, false, false, false);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testQuietArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, null, false, false, false, true, false, false);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testDebugArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, null, false, false, false, false, true, false);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testForceArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, null, false, false, false, false, false, true);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testForceArgInstall() throws Exception {
        ...
        Arg expectedArg = new Arg(null, "/test/app.apk", null, null, false, false, false, false, false, true);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testArgCombination() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, "C:\\test\\mypath\\adb.exe", "IR2131236", false, true, true, false, false, false);
        assertEquals(parsedArg, expectedArg);
    }
