...
public class CLIParserTest {
    ...
    public void testSimpleUninstallWithOnlyFilter() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.andoid.*"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        ...
        Arg expectedArg1 = new Arg(new String[]{"com.andrid.*", "com.google.*"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
    ...
    public void testSimpleInstallWithOnlyFile() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"app.apk"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.INSTALL);
        assertEquals(expectedArg, parsedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_INSTALL + " ./"));
        Arg expectedArg1 = new Arg(new String[]{"./"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.INSTALL);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testSimpleBugReportWithOnlyFile() throws Exception {
        ...
        Arg expectedArg = new Arg(null, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.BUGREPORT);
        assertEquals(expectedArg, parsedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_BUGREPORT + " /mnt/test/"));
        Arg expectedArg1 = new Arg(new String[]{"/mnt/test/"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.BUGREPORT);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testSimpleForceStop() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.mandroid.*"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.FORCE_STOP);
        assertEquals(expectedArg, parsedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_FORCE_STOP + " com.kandroid.* com.lgoogle.*"));
        Arg expectedArg1 = new Arg(new String[]{"com.kandroid.*", "com.lgoogle.*"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.FORCE_STOP);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testSimpleInfo() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.mndroid.*"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.INFO);
        assertEquals(expectedArg, parsedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_APPINFO + " com.kandrid.* com.lgoogle.*"));
        Arg expectedArg1 = new Arg(new String[]{"com.kandrid.*", "com.lgoogle.*"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.INFO);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testSimpleClear() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.madroid.*"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.CLEAR);
        assertEquals(expectedArg, parsedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_CLEAR_DATA + " com.ndroid.* com.lgoogl.*"));
        Arg expectedArg1 = new Arg(new String[]{"com.ndroid.*", "com.lgoogl.*"}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.CLEAR);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testAdbPathArg() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.android.*"}, "C:\\test\\my path\\adb.exe", null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(expectedArg, parsedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_UNINSTALL + " com.android.* --adbPath C:\\test\\mypath\\adb.exe"));
        Arg expectedArg1 = new Arg(new String[]{"com.android.*"}, "C:\\test\\mypath\\adb.exe", null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testDeviceArg() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.android.*"}, null, "IR2131236", null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testDryrunLongArg() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.android.*"}, null, null, null, null, true, false, false, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testSkipEmusLongArg() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.android.*"}, null, null, null, null, false, true, false, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testKeepDataLongArg() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.android.*"}, null, null, null, null, false, false, true, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testUpgradeLongArg() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"/data/app.apk"}, null, null, null, null, false, false, true, false, false, false, false, false, false, Arg.Mode.INSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testQuietLongArg() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.android.*"}, null, null, null, null, false, false, false, true, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testUninstallAndDebugLongArg() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.android.*"}, null, null, null, null, false, false, false, false, true, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testForceLongArg() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.android.*"}, null, null, null, null, false, false, false, false, false, true, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testForceArgInstall() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"/test/app.apk"}, null, null, null, null, false, false, false, false, false, true, false, false, false, Arg.Mode.INSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testGrantArgInstall() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"/test/app.apk"}, null, null, null, null, false, false, false, false, false, false, true, false, false, Arg.Mode.INSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testWaitForDevice() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"/test/app.apk"}, null, null, null, null, false, false, false, false, false, false, false, false, true, Arg.Mode.INSTALL);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testBugReportWithoutFileWithSimple() throws Exception {
        ...
        Arg expectedArg = new Arg(null, null, null, null, null, false, false, false, false, false, false, false, true, false, Arg.Mode.BUGREPORT);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testBugReportWithoutFileWithDumpsys() throws Exception {
        ...
        Arg expectedArg = new Arg(null, null, null, null, new String[]{"permissions", "nfc", "connectivity"}, false, false, false, false, false, false, false, false, false, Arg.Mode.BUGREPORT);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testBugReportWithoutFileAndAdditionalArgument() throws Exception {
        ...
        Arg expectedArg = new Arg(null, null, "I3479822", null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.BUGREPORT);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testBugReportWithoutFileAndIntent() throws Exception {
        ...
        Arg expectedArg = new Arg(null, null, null, new String[]{"at.psa.*", "-a", "${package}/.Activity", "--ez", "HEADLESS", "true"}, null, false, false, false, false, false, false, false, false, false, Arg.Mode.BUGREPORT);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testBugReportWithoutFileAndIntentAndSerial() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"test"}, null, "AR124332", new String[]{"at.psa.*", "secondArg"}, null, false, false, false, false, false, false, false, false, false, Arg.Mode.BUGREPORT);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testArgCombination() throws Exception {
        ...
        Arg expectedArg = new Arg(new String[]{"com.android.*"}, "C:\\test\\mypath\\adb.exe", "IR2131236", null, null, false, true, true, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(expectedArg, parsedArg);
    }
