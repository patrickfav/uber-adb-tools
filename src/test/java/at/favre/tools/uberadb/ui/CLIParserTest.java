...
public class CLIParserTest {
    ...
    public void testSimpleUninstallWithOnlyFilter() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        ...
        Arg expectedArg1 = new Arg("com.android.*,com.google.*", null, null, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
    ...
    public void testSimpleInstallWithOnlyFile() throws Exception {
        ...
        Arg expectedArg = new Arg("app.apk", null, null, false, false, false, false, false, false, Arg.Mode.INSTALL);
        assertEquals(parsedArg, expectedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_INSTALL + " ./"));
        Arg expectedArg1 = new Arg("./", null, null, false, false, false, false, false, false, Arg.Mode.INSTALL);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testSimpleBugReportWithOnlyFilter() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, false, false, false, false, false, false, Arg.Mode.BUGREPORT);
        assertEquals(parsedArg, expectedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_BUGREPORT + " com.android.*,com.google.*"));
        Arg expectedArg1 = new Arg("com.android.*,com.google.*", null, null, false, false, false, false, false, false, Arg.Mode.BUGREPORT);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testAdbPathArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", "C:\\test\\my path\\adb.exe", null, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg, expectedArg);

        Arg parsedArg1 = CLIParser.parse(asArgArray("-" + CLIParser.ARG_UNINSTALL + " com.android.* -adbPath C:\\test\\mypath\\adb.exe"));
        Arg expectedArg1 = new Arg("com.android.*", "C:\\test\\mypath\\adb.exe", null, false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg1, expectedArg1);
    }
    ...
    public void testDeviceArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, "IR2131236", false, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testDryrunArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, true, false, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testSkipEmusArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, false, true, false, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testKeepDataArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, false, false, true, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testUpgradeArg() throws Exception {
        ...
        Arg expectedArg = new Arg("/data/app.apk", null, null, false, false, true, false, false, false, Arg.Mode.INSTALL);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testQuietArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, false, false, false, true, false, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testDebugArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, false, false, false, false, true, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testForceArg() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", null, null, false, false, false, false, false, true, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testForceArgInstall() throws Exception {
        ...
        Arg expectedArg = new Arg("/test/app.apk", null, null, false, false, false, false, false, true, Arg.Mode.INSTALL);
        assertEquals(parsedArg, expectedArg);
    }
    ...
    public void testArgCombination() throws Exception {
        ...
        Arg expectedArg = new Arg("com.android.*", "C:\\test\\mypath\\adb.exe", "IR2131236", false, true, true, false, false, false, Arg.Mode.UNINSTALL);
        assertEquals(parsedArg, expectedArg);
    }
