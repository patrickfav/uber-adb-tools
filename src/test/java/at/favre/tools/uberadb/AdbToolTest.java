...
public class AdbToolTest {
    ...
    public void testSimpleUninstallMultiDevices() throws Exception {
        Arg arg = new Arg(new String[]{"com.example.*"}, null, null, null, null, false, false, false, false, false, true, false, false, false, Arg.Mode.UNINSTALL);
    ...
    public void testSimpleInstallMultiDevices() throws Exception {
        Arg arg = new Arg(new String[]{apks.getAbsolutePath()}, null, null, null, null, false, false, false, false, false, true, false, false, false, Arg.Mode.INSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
    ...
    public void testSimpleInstallMultiDevicesMultipleFiles() throws Exception {
        ...
        Arg arg = new Arg(new String[]{files[0].getAbsolutePath(), files[1].getAbsolutePath()}, null, null, null, null, false, false, false, false, false, true, true, false, false, Arg.Mode.INSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
        assertNotNull(result);
    ...
    public void testSimpleInstallMultiDevicesGrant() throws Exception {
        Arg arg = new Arg(new String[]{apks.getAbsolutePath()}, null, null, null, null, false, false, false, false, false, true, true, false, false, Arg.Mode.INSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
        assertNotNull(result);
        check(result, apks.listFiles().length * adbDevices.size(), 0, adbMockCmdProviderMultiDevices.deviceCount());
    }
    ...
    public void testSimpleUninstallOneDeviceTwoPackages() throws Exception {
        Arg arg = new Arg(new String[]{"com.example.app1", "com.example.app2"}, null, null, null, null, false, false, false, false, false, true, false, false, false, Arg.Mode.UNINSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderSingleDevice);
    ...
    public void testSimpleInstallMultiDevicesSingleApk() throws Exception {
        Arg arg = new Arg(new String[]{apks.listFiles()[0].getAbsolutePath()}, null, null, null, null, false, false, false, false, false, true, false, false, false, Arg.Mode.INSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
    ...
    public void testSimpleUninstallMultiDevicesSelectSpecific() throws Exception {
        Arg arg = new Arg(new String[]{"com.example.*"}, null, adbDevices.get(0).serial, null, null, false, false, false, false, false, true, false, false, false, Arg.Mode.UNINSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
    ...
    public void testSimpleUninstallMultiDevicesDryRun() throws Exception {
        Arg arg = new Arg(new String[]{"com.example.*"}, null, null, null, null, true, false, false, false, false, true, false, false, false, Arg.Mode.UNINSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
    ...
    public void testSimpleUninstallMultiDevicesSkipEmu() throws Exception {
        Arg arg = new Arg(new String[]{"com.example.*"}, null, null, null, null, false, true, false, false, false, true, false, false, false, Arg.Mode.UNINSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
    ...
    public void testSimpleInstallMultiDevicesSelectSpecific() throws Exception {
        Arg arg = new Arg(new String[]{apks.getAbsolutePath()}, null, adbDevices.get(0).serial, null, null, false, false, false, false, false, true, false, false, false, Arg.Mode.INSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
    ...
    public void testSimpleInstallMultiDevicesDryRun() throws Exception {
        Arg arg = new Arg(new String[]{apks.getAbsolutePath()}, null, null, null, null, true, false, false, false, false, true, false, false, false, Arg.Mode.INSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
        check(result, 0, 0, adbMockCmdProviderMultiDevices.deviceCount());
    }
    ...
    public void testSimpleInstallMultiDevicesSkipEmu() throws Exception {
        Arg arg = new Arg(new String[]{apks.getAbsolutePath()}, null, null, null, null, false, true, false, false, false, true, false, false, false, Arg.Mode.INSTALL);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
    ...
    public void testSimpleBugReport() throws Exception {
        Arg arg = new Arg(new String[]{temporaryFolder.newFolder().getAbsolutePath()}, null, null, null, null, false, false, false, false, false, false, false, false, false, Arg.Mode.BUGREPORT);
        Commons.ActionResult result = AdbTool.execute(arg, adbMockCmdProviderMultiDevices);
        check(result, 0, 0, adbMockCmdProviderMultiDevices.deviceCount());
    }
